...
%% Second MLP architecture (25 node input layer, 2 hidden layers (25 nodes), 1 node output layer)
...
best_net2 = patternnet([25 25], 'traingdx'); % feedforward network with 2 hidden and 25 nodes each
...
%% (f1 score = 0.4643, cohens kapa = 0.3569, accuracy = 80.88%, time = 9.2)
